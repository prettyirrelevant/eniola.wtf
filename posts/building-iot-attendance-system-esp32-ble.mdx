...
BLE debugging is challenging because you can't always see what's happening. I implemented extensive logging and debugger -- spamming `Serial.println(output)` everywhere.

...
tags: railway django til hacks
---

[Railway](https://railway.app) has been my defacto choice for hosting web applications since the removal of free tier[^1] on Heroku. The developer experience is **quite** similar to that of Heroku as it supports the use of `Procfile`, unlike other services that force you to use Dockerfiles or learn a new configuration. Why **quite**? Well, stick around.
...
> *Only a single process type is supported at the moment*[^2].
...
So, how do I run both the server and Huey consumer simultaneously? Using a bash script since I can easily run gunicorn in **daemon mode**[^3]. Here's how it looks.
...
[^1]: https://blog.heroku.com/next-chapter
[^2]: https://docs.railway.app/guides/build-configuration#procfiles
[^3]: https://docs.gunicorn.org/en/stable/settings.html#daemon
